        ...
        <div className="relative">
          ...
          >
            ...
            <Image
              ...
              width={10}
              height={10}
              className="absolute top-2 right-5 w-[10px] h-[10px]"
            />
          </div>
          {isOpen && (
          ...
          isWideScreen && (
            <div className="flex justify-between gap-5">
              <button
                ...
                className={` hover:opacity-80 ${viewMode === "grid" ? "filter invert" : ""
                  }`}
              >
              ...
              <button
                ...
                className={` hover:opacity-80 ${viewMode === "list" ? "filter invert" : ""
                  }`}
              >
                <Image src="/icon/list.svg" alt="иконка список" width={15} height={15} className="w-[15px] h-[15px]" />
              </button>
              <button
                onClick={() => handleViewChange("table")}
                className={` hover:opacity-80 ${viewMode === "table" ? "filter invert" : ""
                  }`}
              >
